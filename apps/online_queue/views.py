from apps.online_queue.serializers import StudentSerializer, StudentPhotoSerializer, NewSerializer, OnlineQueueSerializer, NewPhotoSerializer
from apps.online_queue.models import Student, StudentPhoto, OnlineQueue, NewPhoto, New

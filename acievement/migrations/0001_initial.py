    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school', models.ForeignKey(max_length=255, null=True, on_delete=django.db.models.deletion.SET_NULL, to='school.school', verbose_name='школа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('points', models.IntegerField(verbose_name='оценки')),
                ('year', models.IntegerField(verbose_name='год')),
                ('school_fullname', models.ForeignKey(max_length=255, null=True, on_delete=django.db.models.deletion.SET_NULL, to='school.school', verbose_name='название школы')),
